...
Use this template to create a new repository and select yourself as the owner, clone it on your machine and create a new environment inside the folder. Don't forget to activate it for the assignment. 
